...
public interface UsersDao {
    ...
    @SqlQuery("SELECT * FROM USERS WHERE idUser LIKE CONCAT('%', :filtro, '%') OR firstName LIKE CONCAT('%', :filtro, '%') OR lastName LIKE CONCAT('%', :filtro, '%') OR email LIKE CONCAT('%', :filtro, '%')")
    List<User> getUsersByFilter(@Bind("filtro") String filtro);
